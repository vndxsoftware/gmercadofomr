                                ...
                                <div style="margin-top: 20px; color:green">
                                    ...
                                    if (isset($_POST['first_name']) && isset($_POST['middle_name']) && isset($_POST['last_name']) && isset($_POST['emailaddress']) && isset($_POST['phone_number'])) {
                                        if (strlen($errorDetails) == 0) {
                                            ...
                                            $message = "                                                       
                                            <p>Estimado $name,</p>
                                            <p style='margin:0'><span size='3'>Gracias por abrir su cuenta demo con GFC, l&iacute;der mundial en operaciones cambiarias en l&iacute;nea de Forex, &Iacute;ndices, Metales, Petr&oacute;leo, etc.&nbsp;</span></p>                                                      
                                            <p style='margin:0'><span size='3'>No solo ver&aacute; los mejores precios interbancarios, sino que tambi&eacute;n tendr&aacute; la liquidez del mercado mundial en sus manos. Desde gr&aacute;ficas avanzadas, hasta herramientas intrincadas que le facultan para generar sus propios indicadores t&eacute;cnicos para los mercados burs&aacute;tiles.&nbsp;</span></p>
                                          
                                            <p style='margin:0'>Nuestra plataforma es la &uacute;nica dise&ntilde;ada para operar inversiones y atender a operadores tanto principiantes, como profesionales.</p>                                                     
                                            <p style='margin:0'><span size='3'>Seguidamente encontrar&aacute; su&nbsp;</span><span size='3'><strong>ID</strong></span><span size='3'>&nbsp;de usuario y&nbsp;</span><span size='3'><strong>Contrase&ntilde;a</strong></span><span size='3'>&nbsp;para entrar a la plataforma los cuales le dar&aacute;n acceso a su cuenta de demostraci&oacute;n para sus operaciones.&nbsp;</span></p>
                                            <p><strong>Usuario</strong>: $loginName</p>
                                            <p><strong>Contrase&ntilde;a</strong>: $loginPassword</p>
                                            ...
                                            <p style='margin:0'><strong>IPhone / IPad / Apple IOS</strong> &gt; App Store y baje el programa gratis bajo <strong>&ldquo;GFC Web Trader&rdquo;</strong> o</p>
                                            <p style='margin:0'>presione aqui&gt; <a href='https://apps.apple.com/us/app/gfc-web-trader/id6446778457'><u>App Store</u></a></p>
                                            <br>
                                            <p style='margin:0'><strong>Android / Tablet</strong> &gt; Google Play y baje el programa gratis bajo <strong>&ldquo;GFC Web Trader&rdquo;</strong> o</p>
                                            <p style='margin:0'>Presione aqui&gt;<a href='https://play.google.com/store/apps/details?id=com.gfc.mobile'><u>Google Play</u></a></p>
                                            <p>Por favor nos llama con cualquier duda al tel&eacute;fono directo 210-595-3390.</p>
                                            <p style='margin:0'>Gracias.</p>
                                            <p style='margin:0'>Atentamente,</p>
                                            <p style='margin:0'>Global Financial Contracts LTD</p>
